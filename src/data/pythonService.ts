...
import type { Announcement, DataProvider, EtfQuote, FinancialReport, FundInfo, FundRankItem, FundSearchItem, HistoryBar, NewsItem, NewsSort, Quote } from './provider.js';
