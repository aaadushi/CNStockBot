...
| 文件 | 来源 |
|---|---|
| `quote-600519.json` | 2026-09-15 重录（F3-3）：`GET https://push2delay.eastmoney.com/api/qt/stock/get?secid=1.600519&fields=f43,f44,f45,f46,f47,f48,f50,f57,f58,f60,f170,f86,f116,f117,f162,f163,f164,f167,f168`（带 Referer 头）。**用 push2delay 是因为当日 push2 对本机 IP 限流未解除**；两者响应结构同构（延时行情，数值是延时的不影响解析验证）。首录于 2026-09-14（push2，仅旧字段） |
